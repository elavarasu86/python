...
# Below print statement used to print string version of the object.
# When below statement executes call goes to __str__ fn. If user definition is not mentioned then python prints the memory address of object.
